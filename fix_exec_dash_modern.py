with open('templates/executive_dashboard_modern.html', 'r') as f:
    content = f.read()
  ...
  <div class="tab-pane fade {% if active_tab == 'inventory_status' %}show active{% endif %}" id="inventory_status">
      <div class="card">
          <div class="card-header">
              <h5 class="card-title">Inventory Monthly Usage</h5>
          </div>
          <div class="card-body">
...
with open('templates/executive_dashboard_modern.html', 'w') as f:
    f.write(content)
