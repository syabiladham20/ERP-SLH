...
# I will rewrite the flock_charts.html script correctly
new_script = """
...
# replace everything from <script src="https://cdn.plot.ly/plotly-2.27.0.min.js"></script> to the end of the file
pattern = re.compile(r'<script src="https://cdn.plot.ly/plotly-2.27.0.min.js"></script>.*?</script>', re.DOTALL)
